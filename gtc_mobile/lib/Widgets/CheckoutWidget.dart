          ...
          itemBuilder: (context, index) {
            ...
            return FutureBuilder<TenantMenuModel>(
              ...
              builder: (context, tenantMenuSnapshot) {
                if (tenantMenuSnapshot.connectionState == ConnectionState.waiting) {
                            ...
                            content: Column(
                              ...
                              children: [
                                ...
                                DropdownButtonFormField<int>(
                                  value: _temptSelectedMejaNumber ?? _selectedMejaNumber,
                              ...
                              TextButton(
                                onPressed: () {
                                  if (_temptSelectedMejaNumber != null) {
                                    setState(() {
                                      _selectedMejaNumber = _temptSelectedMejaNumber;
                                    });
                                  }
                                  Navigator.of(context).pop();
                                },
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      int? maxIdPesanan;
                      try {
                        maxIdPesanan = await PesananTenantsService.getMaxIdPesanan();
                      } catch (e) {
                        debugPrint('Failed to get max idPesanan: $e');
                        return;
                      }

                      final newIdPesanan = (maxIdPesanan != null ? maxIdPesanan + 1 : 1);
                      final cartItems = await _futureCartItems;
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: Text("Apakah Anda yakin ingin melakukan pemesanan? Pastikan pesanan Anda sudah benar."),
                            actions: <Widget>[
                              TextButton(
                                child: Text("Batal"),
                                onPressed: () {
                              ...
                              ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  for (final cartItem in cartItems) {
                                    ...
                                    try {
                                      await PesananTenantsService.createPesanan(pesananTenant);
                                    } catch (e) {
                                      debugPrint('Failed to create pesanan: $e');
                                    }
                                  }
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => PaymentConfirmationLoadPage(),
                                    ),
                                  );
                                },
                              ),
